...
import com.cart.cartItem.config.ServiceConfig;
import com.cart.cartItem.utils.UserContextInterceptor;
...
public class CartItemApplication {
	...
	private static final Logger logger = LoggerFactory.getLogger(CartItemApplication.class);
